...
module.exports = {
  ...
  seederMovie: async (req, res) => {
    ...
    request(
      `https://api.themoviedb.org/3/discover/movie?api_key=e13394375a09fbd46812b9a5d6e44045&query=a&primary_release_date.gte=2019-05-01&primary_release_date.lte=2019-06-10`,
      (err, response, body) => {
        if (err) {
